...
typedef struct {
  ...
  pulseProcessorV2SweepBlock_t blocks[DECK_LIGHTHOUSE_MAX_N_BS];

  // Timestamp of the rotor zero position for the latest processed slowBit
  uint32_t ootxTimestamps[DECK_LIGHTHOUSE_MAX_N_BS];
} pulseProcessorV2_t;

typedef struct pulseProcessor_s {
  bool receivedBsSweep[DECK_LIGHTHOUSE_MAX_N_BS];
  ...
  ootxDecoderState_t ootxDecoder[DECK_LIGHTHOUSE_MAX_N_BS];
  lighthouseCalibration_t bsCalibration[DECK_LIGHTHOUSE_MAX_N_BS];
  baseStationGeometry_t bsGeometry[DECK_LIGHTHOUSE_MAX_N_BS];
  baseStationGeometryCache_t bsGeoCache[DECK_LIGHTHOUSE_MAX_N_BS];
...
typedef struct {
  pulseProcessorBaseStationMeasurement_t baseStationMeasurementsLh1[DECK_LIGHTHOUSE_MAX_N_BS];
  pulseProcessorBaseStationMeasurement_t baseStationMeasurementsLh2[DECK_LIGHTHOUSE_MAX_N_BS];
  lighthouseBaseStationType_t measurementType;
  uint64_t lastUsecTimestamp[DECK_LIGHTHOUSE_MAX_N_BS];
